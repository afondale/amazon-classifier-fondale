...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DUK13OXK.js
...
var styles_default = "/assets/styles-DGuhN-MB.css";
var APP_NAME = "Foil";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Foil classifies Amazon gift-card reviews as positive or negative from title and body only."
			},
			{
				name: "theme-color",
				content: "#0a0b0c"
...
var $$splitComponentImporter = () => import("./routes-CCGdKw9T.mjs");
